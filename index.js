...
function filterUnfundedOnly() {
    ...
    // log the length of the filtered array to the console
...
const descriptionString = `A total of $${totalRaised.toLocaleString()} has been raised for ${totalGames} games. Currently, ${unfundedGamesCount} ${unfundedGamesCount === 1 ? "game remains" : "games remain"} unfunded. We need your help to fund these amazing games!`;
...
// Destructure the first two games from the sorted array
const [firstGame, secondGame, ...rest] = sortedGames;

const firstWordFirstGame = firstGame.name.split(" ")[0];
const firstWordSecondGame = secondGame.name.split(" ")[0];
console.log("First word of most funded game:", firstGame.name.split(" ")[0]);
console.log("First word of second most funded game:", secondGame.name.split(" ")[0]);

// Create elements to hold their names
...
// Create element for the top funded game
const topGameElement = document.createElement('p');
topGameElement.textContent = firstGame.name;
firstGameContainer.appendChild(topGameElement);

// Create element for the second most funded game
